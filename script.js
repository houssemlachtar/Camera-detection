...
function testSupport(supportedDevices) {
    ...
    if (!isSupported) {
        alert(`This service, running on ${detectedDevice.client.name}, ` +
            `is not well supported at this time, i'm working on fixing some slowness bugs, press ok to continue though.`);
    }
    alert(`Make sure your internet is stable.`);
}
...
new controls
    ...
    .add([
        new controls.StaticText({ title: 'Body Detection' }),
        fpsControl,
